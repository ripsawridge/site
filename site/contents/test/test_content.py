...
class ContentTest(unittest.TestCase):
    def setUp(self):
        ...
        self.subdir_path = os.path.join(self.blog_path, "1999")
        self.subfile_path = os.path.join(self.subdir_path, "funny.md")
    ...
    def test_subdir_content(self):
        content = makesite.read_content(self.subfile_path, self.blog_path + '/')
        expected_slug = os.path.join('1999', 'funny')
        self.assertEqual(content['slug'], expected_slug)
