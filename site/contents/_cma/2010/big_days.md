...
{% image images/the-gates-of-hell_4688100772_o.jpg %}
...
{% image images/hunt-the-wumpus_4688101664_o.jpg %}
...
{% image images/beautiful-hell-valley_4688103924_o.jpg %}
{% image images/im-going-where_4687471237_o.jpg %}
{% image images/getting-closer_4687472761_o.jpg %}
{% image images/you-must-be-joking_4687473797_o.jpg %}
{% image images/now-i-know-you-are-joking_4688108126_o.jpg %}
...
{% image images/peeple_4687476739_o.jpg %}
{% image images/coldforbidding_4688110728_o.jpg %}
{% image images/scenic-overlook_4687478953_o.jpg %}
...
{% image images/room-for-one_4687479911_o.jpg %}
<i>Lunchtime!</i>

{% image images/the-cruxy-crux_4687480685_o.jpg %}
<i>The crux of the climb was the transition between snow and rock just below.</i>

{% image images/on-the-ridge_4687481421_o.jpg %}
{% image images/the-eibsee_4688115320_o.jpg %}
{% image images/gold_4687483111_o.jpg %}
{% image images/savage-wilderness_4688116852_o.jpg %}
{% image images/wilderness-gently-moderated_4688117620_o.jpg %}
{% image images/this-is-us_4688118452_o.jpg %}

{% image images/but-people-are-nice_4688119272_o.jpg %}
...
{% image images/capture-evaded_4688120528_o.jpg %}
<i>Halfway down the route to the Wiener Neustadter Hütte</i>

{% image images/the-nw-hut_4688120926_o.jpg %}
<i>The sadly closed Hütte</i>

{% image images/here-is-the-face_4688121436_o.jpg %}
...
{% image images/healing-vistas_4687488979_o.jpg %}
<i>Whew, jus' hikin' again</i>

{% image images/a-last-look_4688123022_o.jpg %}
{% image images/lift-station_4687490935_o.jpg %}
{% image images/the-wall_4688124900_o.jpg %}


The Westliche Marienbergspitze, June 12, 2010
---
{% image images/the-peaks_4695855655_o.jpg %}
...
{% image images/wannig_4695857093_o.jpg %}
{% image images/st-barbara-and-the-route_4695858271_o.jpg %}
{% image images/morning-flowers_4695859567_o.jpg %}
...
{% image images/the-crux-of-the-route-above_4695861307_o.jpg %}
{% image images/lots-of-scrambling-terrain_4695862769_o.jpg %}
{% image images/looking-down_4696497568_o.jpg %}
...
{% image images/the-way-of-the-white-snake_4695865821_o.jpg %}
<i>The white rock is the "Way of the White Serpent"</i>

{% image images/the-ridge-with-wannig_4696500490_o.jpg %}
<i>Views on the ridge</i>

{% image images/typical-ridge-scenery_4696501878_o.jpg %}
{% image images/terrain-eases_4695870055_o.jpg %}
{% image images/shattered-scree_4695871479_o.jpg %}
<i>Just scree to the summit now...</i>

{% image images/wamperter-schrofen_4695872621_o.jpg %}
{% image images/a-shaky-summit-photo_4696507594_o.jpg %}
<i>Jittery summit picture</i>

{% image images/western-peaks-of-the-mieming-range_4696509186_o.jpg %}
...
{% image images/the-schwaerzkar_4696510472_o.jpg %}
<i>The Schwärzkar</i>

{% image images/the-sun-is-coming_4695878113_o.jpg %}
{% image images/a-snowy-basin_4695879171_o.jpg %}


The Ehrwalder Sonnenspitze (same day)
---
{% image images/the-ehrwalder-sonnenspitze_4696513826_o.jpg %}
...
{% image images/the-ehrwalder-sonnenspitze_4696515294_o.jpg %}
<i>Don't be like me and try the left skyline! The correct way starts from the high scree fan to the right.</i>

{% image images/lunchtime_4695883229_o.jpg %}
<i>Ah, civilization!</i>

{% image images/the-clouds-are-coming_4696517586_o.jpg %}
<i>Here come the clouds...</i>

{% image images/the-biberwierer-scharte_4695885651_o.jpg %}
<i>The Biberwierscharte, my exit ramp.</i>

{% image images/not-the-right-way_4695887097_o.jpg %}
...
{% image images/cant-get-there-from-here_4695888651_o.jpg %}
...
{% image images/on-the-correct-route_4695889693_o.jpg %}
<i>The right way.</i>
{% image images/tantalizing-glimpse_4696524202_o.jpg %}
<i>Escaping the cloud...</i>
{% image images/a-precipitious-scenic-trail_4695892115_o.jpg %}
<i>Beautiful trail and scrambling.</i>

{% image images/the-marienbergspitze_4695892995_o.jpg %}
...
{% image images/final-slopes_4695894281_o.jpg %}
<i>Final slopes...</i>

{% image images/on-top_4695895701_o.jpg %}
<i>On top!</i>
...
{% image images/self-portrait_4696529934_o.jpg %}
