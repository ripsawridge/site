...
module.exports = (env, callback) ->
  ...
  options = env.config.paginator_report or {}
  ...
  getArticles = (contents) ->
    ...
    articles = []
    dirs = contents[options.articles]._.directories.map (item) -> item
    for item in dirs
  ...
  env.registerGenerator 'paginator_report', (contents, callback) ->
    ...
    rv['index_report.page'] = pages[0] # alias for first page
